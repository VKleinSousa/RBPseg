...
def main():
    ...
    description=textwrap.dedent('''\
            ___________________________________________
                        RBPseg-merge v1.1.1
            ___________________________________________
            The RBPseg-merge module performs superimposition and merging of fractions.
            
            Remember to prepare your directory before using this. If AF2 or AF3 generated your files, you can use the script: rbpseg/merge/prepare_files_for_merge.py 
