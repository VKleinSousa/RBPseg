...
def main():
    ...
    description=textwrap.dedent('''\
            ...
            Remember to prepare your directory before using this. If your files were generated by AF2 or AF3 you can use the script: rbpseg/merge/prepare_files_for_merge.py 
            '''),
    ...
    merged_structure = superimpose_and_merge(pdb_files, overhang_size, superimpose_function, name, overhang_list, change_bfactor, chain_mode)
